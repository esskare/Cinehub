    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cinema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cinema_show', to='myapp.Cinema')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movie_show', to='myapp.Movie')),
            ],
        ),
        migrations.CreateModel(
            name='Bookings',
            fields=[
                ...
                ('shows', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.Shows')),
